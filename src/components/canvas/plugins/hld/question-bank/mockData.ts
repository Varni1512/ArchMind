import { HLDQuestion } from './types';

export const mockQuestions: HLDQuestion[] = [
  {
    id: 'q-1',
...
export const getQuestions = (): HLDQuestion[] => {
  return mockQuestions;
};

export const getQuestionById = (id: string): HLDQuestion | undefined => {
